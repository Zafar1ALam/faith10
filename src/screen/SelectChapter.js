                ...
                renderItem={({ item }) => {
                    return (
                        ...
                        <TouchableRipple
                            ...
                            onPress={() => {
                                navigation.navigate("SelectChapterDescription",
                                    { routeChapterNo: item.id })
                            }}>
                            <View style={{
                                flexDirection: "row",
                                ...
                                <Text style={STYLES.fontSize16_whiteFFFFFF_MADE_TOMMY_Regular_PERSONAL_USE_Regular}>{item.number}</Text>
